...
public class MappingsConfigurationUTest {
    ...
    public void entityManagerFactory_should_create_new_entity_manager_factory_using_superclass_and_configure_mapping_resources() {
        ...
        MappingsConfiguration mappingsConfiguration = new MappingsConfiguration(mock(DataSource.class), mock(JpaProperties.class), mock(ObjectProvider.class), mock(ObjectProvider.class)) {
            @Override
